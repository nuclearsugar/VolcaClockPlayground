...
4. If you have a line-in signal, turn up `View Signal` and make sure the the VU meter is moving.
  - This is just to make sure that the Volca clock is actually receiving correctly. If you don't see the VU meter moving at all, then your settings probably aren't setup correctly either in Pure Data or elsewhere. 
